...
*/
static inline uint8_t arena_delete(arena_t *a);
...
static inline void *arena_alloc(arena_t *a, size_t len);
static inline void *arena_calloc(arena_t *a, size_t nmemb, size_t size);
static inline void *arena_realloc(arena_t *a, void *ptr, size_t size);
...
static inline void sb_push_byte(arena_t *a, string_builder_t *sb, uint8_t byte);
static inline void sb_push_bytes(arena_t *a, string_builder_t *sb, size_t count, ...);
static inline void sb_push_int(arena_t *a, string_builder_t *sb, int i);

static inline void sb_push_cstring(arena_t *a, string_builder_t *sb, const char *str);
static inline char *sb_build_cstring(arena_t *a, string_builder_t sb);
...
static inline void sb_push_byte(arena_t *arena, string_builder_t *sb, uint8_t byte)
{
